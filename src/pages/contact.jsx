                        ...
                        <div class="wow fadeInUp" data-wow-delay="0.3s">
                            ...
                            <form onSubmit={handleFormSubmit}>
                                <div class="row g-3">
                                    ...
                                    <div class="col-12">
                                        <div class="form-floating">
                                            <textarea class="form-control" placeholder="Leave a message here" id="message" style={{ height: "150px" }} value={message} name={message} onChange={handleInputChange}></textarea>
